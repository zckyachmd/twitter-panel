        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              echo form_dropdown('follow', $options, '', ['class' => 'form-control']);
              ?>
            </div>
        ...
        <div class="card bg-dark text-light">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              echo form_dropdown('retweet', $options, '', ['class' => 'form-control']);
              ?>
            </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              echo form_dropdown('favorite', $options, '', ['class' => 'form-control']);
              ?>
            </div>
            <?= form_submit('submit', 'Submit', ['class' => 'btn btn-dark']); ?>
            <?= form_close(); ?>
